...
public class HamsterWheelItem extends class_1747 implements GeoItem {
   ...
   public HamsterWheelItem(Block block, class_1793 properties) {
      ...
      consumer.accept(new RenderProvider() {
         ...
         public class_756 getCustomRenderer() {
            if (this.renderer == null) {
               this.renderer = new GeoItemRenderer(new DefaultedBlockGeoModel(new Identifier("hamsters", "hamster_wheel")));
            }
